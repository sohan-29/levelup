...
const Popup = ({ message, del, cancel }) => {
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50">
            <div className="relative bg-white p-6 rounded shadow-md text-center mb-4 text-black font-mono">
                ...
                <p >Are your sure want to delete <span className="text-red-600">{message}</span>!</p>
                <p className="text-gray-700 text-sm">you can't get back the data of {message} after deleting</p>
                <div onClick={del} className="flex justify-center items-center mt-2 cursor-pointer">
...
const AddActivity = ({ setNewActivity }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex mx-2 items-center mb-4 w-full">
            <input
                type="text"
                value={title}
...
const Activities = () => {
    ...
    return (
        <div onClick={()=>setAddActivity(false)} className="m-3 sm:w-69">
            ...
            <div ref={showAddFeature} onClick={(e) => {e.stopPropagation(); setAddActivity(true);}} className={"flex justify-center cursor-pointer text-2xl font-bold text-yellow-200 hover:text-yellow-300 mt-4 " + (addActivity ? "hidden" : "")}>
